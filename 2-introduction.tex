...
\section{Molecular Visualization}
  ...
  \subsection{Visualization of Physicochemical Properties}
    ...
    \begin{figure}[H]
      ...
      \caption{\label{fig:intro/isosurfaces_umol} Isosurface representations of the whole APBS grid for a protein system (PDB: 1IQJ). The isosurface parameter was set to $5$, so positive charges are being displayed. Left) opaque, Middle) translucid, Right) wireframe.}
    \end{figure}
