...
\section{Characterization of Physicochemical Properties}
  ...
  \subsection{Electrostatic Potential}
    ...
    \begin{figure}[H]
      ...
      \caption{\label{fig:methods/lapbs} [TODO: description. change labels to alphabetical]}
    \end{figure}
...
\section{Benchmarking}
  ...
  The potentials were calculated on the 20 systems, after removing any ligands and considering only the binding pocket of interest from the target macromolecules. The pocket sphere was determined by the selection queries and \textit{Extra size} values defined in tables \ref{tab:appx1/selection_prot} and \ref{tab:appx1/selection_rna}. For the protein systems, interactions described in their experimental sources were taken as the main reference point for validation of the benchmarking. In the case of RNA systems, interactions predicted by PLIP \cite{plip_2021} were taken as reference. A summary of these predictions is provided in table \ref{tab:appx2/plip}. % TODO: add link to the githubpages
