...
\section{Benchmarking}
  ...
  \subsection{RNA Systems}
    ...
    \begin{figure}[H]
      ...
      \caption{\label{fig:benchmark/7oax1} Physical properties of the pocket for the RNA system PDB:7OAX (ligand: V5Z). Potentials displayed: a) stacking, d) hydrogen bond donors.}
    \end{figure}
    ...
    \begin{figure}[H]
      ...
      \caption{\label{fig:benchmark/8eyv} Physical properties of the pocket for the RNA system PDB:8EYV. Potentials displayed: a) stacking, d) hydrogen bond donors.}
    \end{figure}
